...
class Users extends CI_Controller
{
	public function index()
	{
		...
		if (!isset($ceks)) {
			...
			$data['judul_web'] = "Beranda | E-ARSIP";
	...
	public function profile()
	{
		...
		if (!isset($ceks)) {
			...
			$data['judul_web'] 		= "Profile | E-ARSIP";
	...
	public function pengguna($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Pengguna | E-ARSIP";
			} elseif ($aksi == 'd') {
				$p = "pengguna_detail";

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Detail Pengguna | E-ARSIP";
			} elseif ($aksi == 'e') {
				$p = "pengguna_edit";

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Edit Pengguna | E-ARSIP";
			} elseif ($aksi == 'h') {

				$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
				$data['judul_web'] 	  = "Hapus Pengguna | E-ARSIP";
				...
				$data['judul_web'] 	  = "Pengguna | E-ARSIP";
			}
	...
	public function bagian($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Bagian | E-ARSIP";
			} elseif ($aksi == 'e') {
				$p = "bagian_edit";
				if ($data['user']->row()->level == 's_admin') {
					redirect('404_content');
				...
				$data['judul_web'] 	  = "Edit Bagian | E-ARSIP";
			} elseif ($aksi == 'h') {
				...
				$data['query'] = $this->db->get_where("tbl_bagian", array('id_bagian' => "$id"))->row();
				$data['judul_web'] 	  = "Hapus Bagian | E-ARSIP";
	...
	public function sm($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	= "Tambah Surat Masuk | E-ARSIP";
			} elseif ($aksi == 'd') {
				$p = "sm_detail";
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
				$data['judul_web'] 	  = "Detail Surat Masuk | E-ARSIP";
				...
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
				$data['judul_web'] 	  = "Edit Surat Masuk | E-ARSIP";
			} elseif ($aksi == 'h') {
				if ($data['user']->row()->level == 's_admin' or $data['user']->row()->level == 'user') {
					redirect('404_content');
				}
				$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id", 'id_user' => "$id_user"))->row();
				$data['judul_web'] 	  = "Hapus Surat Masuk | E-ARSIP";
				...
				$p = "sm";
				$data['judul_web'] 	  = "Surat Masuk | E-ARSIP";
			}
	...
	public function sk($aksi = '', $id = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($aksi == 't') {
				...
				$data['judul_web'] 	  = "Tambah Surat Keluar | E-ARSIP";
			} elseif ($aksi == 'd') {
				$p = "sk_detail";
				$this->db->join('tbl_user', 'tbl_sk.id_user=tbl_user.id_user');
				$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id"))->row();
				$data['judul_web'] 	  = "Detail Surat Keluar | E-ARSIP";
				...
				$data['judul_web'] 	  = "Edit Surat Keluar | E-ARSIP";
				...
				$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id", 'id_user' => "$id_user"))->row();
				$data['judul_web'] 	  = "Hapus Surat Keluar | E-ARSIP";
				...
				$p = "sk";
				$data['judul_web'] 	  = "Surat Keluar | E-ARSIP";
			}
			...
			if (isset($_POST['no_surat'])) {
				...
				if ($this->upload->do_upload('userfile')) {
					...
					$status   	 	= htmlentities(strip_tags($this->input->post('status_surat')));
					$perihal   	 	= htmlentities(strip_tags($this->input->post('perihal')));
	...
	public function lap_sk()
	{
		...
		if (!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Keluar | E-ARSIP";
	...
	public function data_sk($tgl1 = '', $tgl2 = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($tgl1 != '' and $tgl2 != '') {
				...
				$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
				$data['judul_web'] = "Data Laporan Surat Keluar | E-ARSIP";
				$this->load->view('users/header', $data);
	...
	public function lap_sm()
	{
		...
		if (!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Masuk | E-ARSIP";
	...
	public function data_sm($tgl1 = '', $tgl2 = '')
	{
		...
		if (!isset($ceks)) {
			...
			if ($tgl1 != '' and $tgl2 != '') {
				...
				$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
				$data['judul_web'] = "Data Laporan Surat Masuk | E-ARSIP";
				$this->load->view('users/header', $data);
