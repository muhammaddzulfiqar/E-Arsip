        ...
        <div class="col-md-4">
          <div class="panel panel-info">
            <div class="panel-heading text-center">
              ...
              <h1><b>PEGAWAI / TENAGA KERJA</b></h1>
            </div>
            <div class="panel-body">
              <h1 style="margin-top: 0px; margin-bottom: -10px;"><b>
                  <?php echo number_format($this->db->query("SELECT * FROM tbl_bagian")->num_rows(), 0, ",", "."); ?> PENGGUNA
                </b><a href="users/bagian" class="btn btn-sm btn-primary" style="float: right;">SELENGKAPNYA</a>
              </h1>
            </div>
          </div>
        </div>
