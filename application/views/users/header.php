...
<head>
	...
	<link rel="icon" type="image/png" href="foto/gambar1.png">
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="" style="color: #FFF;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><b>&nbsp;&nbsp;E-ARSIP</b></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
									...
									<li class="<?php if ($sub_menu == "pengguna") {
										...
										<ul>
											...
											<li class="<?php if ($sub_menu == "bagian") {
															echo 'active';
														} ?>"><a href="users/bagian"><i class="icon-database"></i> <b>DATA PENGGUNA</b></a></li>
										</ul>
									</li>
								<?php
								} ?>
								...
								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") {
									...
									<a href="#"><i class="icon-file-spreadsheet"></i> <span><b>DATA ARSIP SURAT / DATA</b></span></a>
									<ul>
										<li class="<?php if ($sub_menu == "sm") {
														echo 'active';
													} ?>"><a href="users/sm"><i class="icon-list"></i> <b>SURAT / DATA MASUK</b></a></li>
										<li class="<?php if ($sub_menu == "sk") {
														echo 'active';
													} ?>"><a href="users/sk"><i class="icon-list"></i> <b>SURAT / DATA KELUAR</b></a></li>
									</ul>
								</li>
								...
								<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") {
									...
									<ul>
										<li class="<?php if ($sub_menu == "lap_sm" or $sub_menu == "data_sm") {
														echo 'active';
													} ?>"><a href="users/lap_sm"><i class="icon-file-empty2"></i> <b>SURAT / DATA MASUK</b></a></li>
										<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "data_sk") {
														echo 'active';
													} ?>"><a href="users/lap_sk"><i class="icon-file-empty2"></i> <b>SURAT / DATA KELUAR</b></a></li>
									</ul>
								</li>
