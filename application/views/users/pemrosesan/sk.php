          ...
          <div class="panel-heading text-left">
            ...
            <div class="row">
              <div class="col-sm-6 text-left">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b class="">&nbsp; DAFTAR SURAT KELUAR</b><br>Sistem Informasi Pengarsipan Data Digital
              </div>
                ...
                ?>
                  <tr <?php if ($baris->peringatan == 1) {
                    ...
                    <td class="text-center">
                      ...
                      <?php
                      if ($user->row()->level == 'admin') { ?>
                        <a href="users/sk/e/<?php echo $baris->id_sk; ?>" class="btn btn-xs btn-primary"><i class="icon-pencil7"></i></a>
                        <a href="users/sk/h/<?php echo $baris->id_sk; ?>" class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                      <?php
                      } ?>
                    </td>
                  </tr>
