                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <input type="text" name="id_surat" id="id_surat" value="<?php echo $query->id_surat; ?>" class="form-control" placeholder="Masukkan ID Surat" readonly>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <input type="text" name="status_surat" id="status_surat" value="<?php echo $query->status_surat; ?>" class="form-control" placeholder="Masukkan Nomor Surat" readonly>
                    </div>
                  </div>
                </div>
