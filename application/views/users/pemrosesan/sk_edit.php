                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <select class="form-control" name="status_surat" id="status_surat" required>
                        <option value="Keluar" <?php if ($query->status_surat == "Keluar") echo "selected" ?>>Keluar</option>
                        <option value="Kedalam" <?php if ($query->status_surat == "Kedalam") echo "selected" ?>>Kedalam</option>
                      </select>
                    </div>
                  </div>
                </div>
