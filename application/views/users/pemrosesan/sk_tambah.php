...
if ($cek_ns->num_rows() == 0) {
  $no_surat       = "SK/" . date('Y') . "/Diskom/001";
} else {
  $noUrut          = substr($cek_ns->row()->id_surat, 15,);
  $noUrut++;
  $no_surat        = "SK/" . date('Y') . "/Diskom/" . sprintf("%03s", $noUrut);
}
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <select class="form-control" name="status_surat" id="status_surat" required>
      ...
      Dropzone.options.myDropzone = {
        ...
        init: function() {
          ...
          this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("status_surat", jQuery("#status_surat").val());
          ...
          this.on("success", function(file, response) {
            ...
            window.location = "<?php echo base_url(); ?>users/sk/";
            //     }
            // });
