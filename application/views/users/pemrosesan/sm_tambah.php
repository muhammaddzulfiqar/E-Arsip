...
$no_surat       = "SM/" . date('Y') . "/Diskom/001";
} else {
  $noUrut          = substr($cek_ns->row()->no_surat, 15,);
  $noUrut++;
  $no_surat        = "SM/" . date('Y') . "/Diskom/" . sprintf("%03s", $noUrut);
}
?>
<!-- Main content -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="input-group">
                        ...
                        <input type="text" name="bagian" id="bagian" required class="form-control" placeholder="Input Bagian">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
